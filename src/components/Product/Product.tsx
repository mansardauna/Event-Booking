...
const Product: React.FC<ProductProps> = ({ productInfo, show }) => {
  ...
  const shortenedLocation = productInfo.location.length > 10 ? `${productInfo.location.substring(0, 10)}...` : productInfo.location;
  ...
  return (
    <div className="border p-2  w-11/12 rounded-md border-slate-400 ">
      ...
      <div className="flex items-center gap-1">
        ...
        <div className="location" title={productInfo.location}>
          {shortenedLocation}
        </div>
      </div>
      </div>
